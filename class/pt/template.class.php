...
class template
{
    ...
    static function trace()
    {
        ...
        ?>
        <style type="text/css">
        #_pt_debug { position:relative; z-index:9999; background-color:rgba(255,255,255,0.9); margin:20px; padding:10px 20px 40px 20px; font:14px/20px Tahoma; border:#666 dashed 1px; opacity:0.5; text-align:left; }
